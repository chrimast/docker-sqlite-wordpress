...
2. Enter `2026.09.10-r1` in **Choose a tag**, choose **Create new tag**, and
...
- `soulteary/sqlite-wordpress:2026.09.10-r1`
- `ghcr.io/soulteary/sqlite-wordpress:2026.09.10-r1`
